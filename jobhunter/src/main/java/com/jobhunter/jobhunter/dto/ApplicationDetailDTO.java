...
public class ApplicationDetailDTO {
    ...
    public void setAppliedAt(LocalDateTime v) {
        this.appliedAt = v;
    }
    ...
    public void setCvFile(String v) {
        this.cvFile = v;
    }
    ...
    public void setUserSkills(List<UserSkill> v) {
        this.userSkills = v;
    }
    ...
    public void setMatchingPercent(int v) {
        this.matchingPercent = v;
    }
}